...
export const foundersData: DataType[] = [
	...
	},
	{
		...
		description:
			"At the helm of Oyelab, we lead with a mission to create powerful solutions that redefine what's possible. Our focus is to drive innovation and deliver impactful results for businesses worldwide.",
		name: 'Faisal Hasan',
		role: 'Co-Founder, Oyelab',
	}	
];
